...
<ProtectedRoute>
  <div className="min-h-screen bg-[#f6f7f9] pb-24">
    ...
    <div className="mx-auto max-w-2xl space-y-3 p-4">
      ...
      {/* EXTERNAL SETTINGS */}
      <Link href="/estimates/completed" target=""
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
        ...
        <div className="space-y-3">
          ...
          <input value={settings.company_name} onChange={(e)=>
          ...
          <input value={settings.company_address} onChange={(e)=>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <input value={settings.company_phone} onChange={(e)=>
            ...
            <input value={settings.company_email} onChange={(e)=>
          ...
          <input value={settings.company_website} onChange={(e)=>
          ...
          <input value={settings.tax_id} onChange={(e)=>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
        ...
        <div className="space-y-2">
          ...
          <input type="range" min="0" max="100" step="5" value={settings.default_deposit_percentage} onChange={(e)=>
          setSettings({
          ...settings,
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
        ...
        <textarea value={settings.terms_conditions} onChange={(e)=>
